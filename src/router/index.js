...
export const asyncRouterMap = [
...

  {
    ...
    children: [
      { path: 'eDoc', component: () => import('@/views/document/eDoc'), name: 'eDoc', meta: { title: 'eDoc', noCache: true }},
      { path: 'pDoc', component: () => import('@/views/document/pDoc'), name: 'pDoc', meta: { title: 'pDoc', noCache: true }},
      { path: 'sDoc', component: () => import('@/views/document/sDoc'), name: 'sDoc', meta: { title: 'sDoc', noCache: true }},
      { path: 'kDocM', component: () => import('@/views/document/kDocM'), name: 'kDocM', meta: { title: 'kDocM', noCache: true }}
      // { path: 'branch', component: () => import('@/views/document/branch'), name: 'branch', meta: { title: 'branch', noCache: true }},
      // { path: 'treeTable', component: () => import('@/views/document/treeTable'), name: 'treeTable', meta: { title: 'treeTable', noCache: true }}
    ]
  },
